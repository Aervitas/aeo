...
from logins.views import LoginView, CheckTokenView, CalendarEventList, BrotherLoginsView, getOTPView, changePasswordView
...
urlpatterns = [
    ...
    path('api/login/changePassword', changePasswordView.as_view(), name='changePassword'),
]
